...
class datetimemanipulation {
    ...
    function __construct() {
        // indonesia
        $this->arr_lang['in1'] = array('1' => 'Januari', '2' => 'Februari', '3' => 'Maret', '4' => 'April', '5' => 'Mei', '6' => 'Juni', '7' => 'Juli', '8' => 'Agustus', '9' => 'September', '10' => 'Oktober', '11' => 'November', '12' => 'Desember', '00' => '--');
        // english
        $this->arr_lang['en1'] = array('1' => 'January', '2' => 'February', '3' => 'Maret', '4' => 'April', '5' => 'May', '6' => 'June', '7' => 'July', '8' => 'August', '9' => 'September', '10' => 'October', '11' => 'November', '12' => 'December', '00' => '--');
        // indonesia
    ...
    public function get_date_yesterday() {
        // hari ind
        $date['hari'] = $this->arr_hari[date('N',time() - 60 * 60 * 24)];
        // tanggal
        $date['tanggal'] = date('d', time() - 60 * 60 * 24);
        // bulan ind
        $date['bulan'] = $this->arr_lang['in'][date('m',time() - 60 * 60 * 24)];
        // tahun
        $date['tahun'] = date('Y',time() - 60 * 60 * 24);
        // return
        return $date;
    }
